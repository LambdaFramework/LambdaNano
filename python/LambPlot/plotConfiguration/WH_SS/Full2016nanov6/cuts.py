...
&& mll>30 \
'
#Electron_pfRelIso03_all[Lepton_electronIdx[0]]<0.15 && Electron_pfRelIso03_all[Lepton_electronIdx[1]]<0.15 && ht>100
...
#Muon_pfRelIso03_all[Lepton_muonIdx[0]]<0.15 && Muon_pfRelIso03_all[Lepton_muonIdx[1]]<0.15 && ht>100
...
cuts['SSmumu_ugo_1jet'] ='nLepton==2 && Sum(CleanJet_pt>30)<2 \
&& ((Lepton_pdgId[0]*Lepton_pdgId[1]==13*13)||(Lepton_pdgId[0]*Lepton_pdgId[1]==-13*-13)) \
&& Muon_pt[Lepton_muonIdx[0]]>25 && Muon_pt[Lepton_muonIdx[1]]>20 \
&& abs(Muon_eta[Lepton_muonIdx[0]])<2.1 && abs(Muon_eta[Lepton_muonIdx[1]])<2.1 \
'
...
cuts['SSee_ugo'] ='nLepton==2 && Sum(CleanJet_pt>30)<3 \
&& ((Lepton_pdgId[0]*Lepton_pdgId[1]==11*11)||(Lepton_pdgId[0]*Lepton_pdgId[1]==-11*-11)) \
&& Electron_pt[Lepton_electronIdx[0]]>30 && Electron_pt[Lepton_electronIdx[1]]>25 \
&& abs(Electron_eta[Lepton_electronIdx[0]])<2.1 && abs(Electron_eta[Lepton_electronIdx[1]])<2.1 \
'
