...
datasets ={
    'Run2_2016_v4': {
        ...
        'mc'   : {
            ...
            Dataset('WW' , 'WpWpJJ_13TeV-powheg-pythia8_TuneCUETP8M1-v1' , 146600 , 0.02093 , 1.0),
            Dataset('WW' , 'WmWmJJ_13TeV-powheg-pythia8_TuneCUETP8M1-v1' , 150000 , 0.007868 , 1.0),
    ...
    'Run2_2017_v2' : {
        ...
        'mc'   : {
            ...
            Dataset('WW' , 'WpWpJJ_EWK-QCD_TuneCP5_13TeV-madgraph-pythia8-v1' , 149000 , 0.04932 , 1.0),
    ...
    'Run2_2018_v4' : {
        ...
        'mc'   : {
            ...
            Dataset('VZ' , 'WZ_TuneCP5_13TeV-pythia8-v1' , 3885000 , 27.6 , 1.0),
            Dataset('VZ' , 'WZTo2L2Q_13TeV_amcatnloFXFX_madspin_pythia8-v1' , 28193648 , 5.606 , 1.0),
            Dataset('VZ' , 'WZTo3LNu_TuneCP5_13TeV-amcatnloFXFX-pythia8-v1' , 10749269 , 5.052 , 1.0),
            Dataset('VZ' , 'WZTo3LNu_TuneCP5_13TeV-amcatnloFXFX-pythia8_ext1-v1' , 11248318 , 5.052 , 1.0),
            ...
            Dataset('VZ' , 'ZZ_TuneCP5_13TeV-pythia8-v1' , 1979000 , 12.14 , 1.0),
            Dataset('VZ' , 'ZZTo2L2Q_13TeV_amcatnloFXFX_madspin_pythia8-v1' , 27900469 , 3.222 , 1.0),
            ...
            Dataset('WW' , 'WpWpJJ_EWK-QCD_TuneCP5_13TeV-madgraph-pythia8-v1' , 150000 , 0.04932 , 1.0),
            Dataset('WW' , 'WpWpJJ_EWK_TuneCP5_13TeV-madgraph-pythia8-v1' , 149400 , 1.0 , 1.0),

            Dataset('WW' , 'WWJJToLNuLNu_EWK_TuneCP5_13TeV-madgraph-pythia8_ext1-v1' , 485000 , 1.0 , 1.0),
