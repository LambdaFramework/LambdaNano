...
from PhysicsTools.NanoAODTools.postprocessing.modules.exampleModule import exampleProducer
exampleModule = lambda : exampleProducer(jetSelection= lambda j : j.pt > 30)

#import PhysicsTools.NanoAODTools.postprocessing.modules.exampleModule1
